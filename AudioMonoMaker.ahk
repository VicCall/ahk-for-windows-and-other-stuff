...
if (track = "right")
{
	 ;msgbox, this is for the RIGHT audio track.
	addPixels = 66
}
else if (track = "left")
{
...
send, ^!1 ;also the audio channels shortcut.
; sleep 15
...
MouseMove, 1111, 872, 0 ;moved the mouse onto the expected location of the "okay" box, which has a distinct white color when the cursor is over it, which will let us know the panel has appeared.
...
MouseMove, 70 + addPixels, 195, 0 ;this is relative to the audio channels window itself. Again, you should reduce these numbers by like 33%...?, since i use 150% UI scaling.
...
sleep 5
MouseMove, 70 + addPixels, 225, 0
;MsgBox, where the hell am i
sleep 30
